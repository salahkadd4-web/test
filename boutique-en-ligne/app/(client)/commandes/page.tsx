                        ...
                        {['EN_ATTENTE', 'CONFIRMEE', 'EN_PREPARATION', 'EXPEDIEE', 'LIVREE'].map((s, i) => {
                          ...
                          return (
                            <div key={s} className="flex items-center flex-1">
                              ...
                              {i < 4 && <div className={`h-0.5 flex-1 ${i < currentIndex ? 'bg-blue-600' : 'bg-gray-200 dark:bg-gray-700'}`} />}
                            </div>
                          )
                        })}
                      </div>
            ...
            {!scanResult ? (
              <>
                ...
                <div className="flex gap-3">
                  ...
                  <button onClick={handleScanLivraison} disabled={scanLoading || scanImages.length === 0}
